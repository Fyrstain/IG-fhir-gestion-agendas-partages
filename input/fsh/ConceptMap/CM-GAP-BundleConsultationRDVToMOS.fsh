...
* insert GroupElement(Bundle.entry:Appointment.resource, RendezVous)
* group[=].element[=].target[=].comment = "L'entrée Appointment du Bundle est mappé vers le modèle logique RendezVous."
...
* insert Group(https://interop.esante.gouv.fr/ig/fhir/gap/StructureDefinition/gap-bundle-reponse-demande-consult-rdv, https://interop.esante.gouv.fr/ig/fhir/MOS/StructureDefinition/PersonnePhysique)
