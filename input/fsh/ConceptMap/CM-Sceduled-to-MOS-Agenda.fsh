...
//
* group[=].element[+].code = #Schedule.meta.extension[availability-time].created
* group[=].element[=].target[+].code = #Agenda.dateCreation
* group[=].element[=].target[=].equivalence = #relatedto
* group[=].element[=].target[=].comment = "Date de création de l'agenda."
//
